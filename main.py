...
async def create_user(
    ...
    #let user auto login if token has already been given
    return await _services.create_token(user)

##This part2 is after server testing run uvicorn main:app --reload first
#give token method
@app.post("/api/token")
